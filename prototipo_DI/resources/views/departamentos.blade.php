...
<div class="bg-white rounded-lg shadow p-6">
    <form method="post" action="{{ route('insertar_dep') }}">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                <label for="maquina" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Maquina</label>
                <input type="text" id="maquina" name="maquina" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Maquina" required>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" id="estatus" name="estatus" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Estatus" required>
            </div>
            <div>
                <label for="auxiliar" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Auxiliar</label>
                <input type="text" id="auxiliar" name="auxiliar" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Auxiliar" required>
            </div>
            <div>
