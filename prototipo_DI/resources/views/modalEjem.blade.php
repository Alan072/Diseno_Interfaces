      ...
      <div class="relative w-full h-full max-w-2xl md:h-auto">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div class="p-6 space-y-6">
                  ...
                  <label>Máquina: 12</label><br>
                  <label>Departamento: Logística</label><br>
                  <label>Status: En proceso</label>
              ...
              <div class="px-6 py-6 lg:px-8">
                  ...
                  <form class="space-y-6" action="#">
                      <div>
                          ...
                          <input type="departamento" name="departamento" id="departamento" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                      </div>
                      <div>
                        <label for="fecha" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fecha</label>
                        <input type="fecha" name="fecha" id="fecha" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="dd/m/aaaa" required>
                    </div>
                    <div>
                        <label for="no.maquinas" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">No. Máquinas</label>
                        <input type="no.maquinas" name="no.maquinas" id="no.maquinas" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                    </div>
                    <div>
                        <label for="no.empleados" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">No. Empleado</label>
                        <input type="no.empleados" name="no.empleados" id="no.empleados" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                    </div>
                    <div>
                        ...
                        <input type="maquinasdisponibles" name="maquinasdisponibles" id="maquinasdisponibles" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                    </div>
                    <div>
                        <label for="extra" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Extra</label>
                        <input type="extra" name="extra" id="extra" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                    </div>
