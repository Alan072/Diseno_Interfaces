...
@section('contenido')
@include('modalEjem')
<span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Registro de Departamentos</span>
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                    {{$item->maquinas_disponibles}} 
                </td>
                <td>
                    {{$item->numero_empleados}} 
                </td>
                <td class="flex items-center">
                    <!--Esta es la linea del boton del documento-->
                    <!----><a href="{{route('depshow', ['id_departamento'=>$item->id_departamento])}}" class="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-70">
                    ...
                    <form action="{{ route('depdestroy', ['id_departamento' => $item->id_departamento]) }}" method="POST" class="inline-block">
                        @csrf
                        @method('DELETE')
